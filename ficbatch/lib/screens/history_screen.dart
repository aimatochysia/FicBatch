...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var logs = history.logs.where((e) {
      ...
      final matchQuery = _query.isEmpty || (e.message.toLowerCase().contains(_query.toLowerCase()));
            ...
            Row(children: [
              ...
              DropdownButton<LogKind?>(
                ...
                items: [
                  ...
                  ...LogKind.values.map((k)=>DropdownMenuItem(value: k, child: Text(logKindLabel(k)))).toList(),
                ],
              ...
              child: ListView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  return Neumorphic(
                    ...
                    child: Row(
                      children: [
                        SizedBox(width: 90, child: Text(_fmt.format(e.at), style: const TextStyle(fontFeatures: []))),
                        const SizedBox(width: 8),
                        Text('[${logKindLabel(e.kind)}]'),
                        const SizedBox(width: 8),
                        Expanded(child: Text(e.message, overflow: TextOverflow.ellipsis)),
                      ],
                    ),
                  );
                },
